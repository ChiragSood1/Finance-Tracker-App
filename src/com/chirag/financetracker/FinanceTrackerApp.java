...
public class FinanceTrackerApp {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 6 -> { System.out.println("Good‑bye!"); return; }
    ...
    private static void viewMenu(TransactionManager m, Scanner sc) {
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 3 -> { System.out.print("Keyword: "); print(m.searchByNotes(sc.nextLine())); }
                case 4 -> { return; }
                default -> System.out.println("Invalid option.");
            }
        }
    ...
    private static void filterMenu(TransactionManager m, Scanner sc) {
        ...
        switch (ch) {
            case 1 -> { System.out.print("Type: "); print(m.filterByType(sc.nextLine())); }
            case 2 -> { System.out.print("Category: "); print(m.filterByCategory(sc.nextLine())); }
            case 3 -> {
                System.out.print("Start date: "); String s = sc.nextLine();
                System.out.print("End date: ");   String e = sc.nextLine();
    ...
    private static void edit(TransactionManager m, Scanner sc) {
        System.out.print("Date to edit: "); String date = sc.nextLine();
        System.out.print("New Type (blank skip): "); String type = sc.nextLine();
        System.out.print("New Category (blank skip): "); String cat = sc.nextLine();
        System.out.print("New Notes (blank skip): "); String notes = sc.nextLine();
        System.out.print("New Amount (-1 skip): "); double v = sc.nextDouble(); sc.nextLine();
    ...
    private static void delete(TransactionManager m, Scanner sc) {
        System.out.print("Date to delete: "); String date = sc.nextLine();
